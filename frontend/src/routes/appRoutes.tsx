...
import HandoutsPage from "../pages/Admin/HandoutsPage/handoutsPage"
import EditCourse from "../pages/editCoursePage/editCoursePage";
			...
			>
				...
				>
					<Routes>
						...
						<Route path="/admin/handouts/:id" element = {<HandoutsPage />} />
