  ...
  export const SurveyDetails = ({survey} : SurveyDetailsProps) => {
    return (
      <div className="text-black text-sm font-medium space-y-2 w-full pt-4 pb-11 mb-24">
        ...
        <p>
          <span className="font-semibold">Questions:</span>  {survey.questions.length}
        </p>
      </div>
    );
  };
...
export default function SurveyCard({survey = defaultSurvey, prerequisites, setPrerequisites }: SurveyProps) {
  ...
  return (
    <div className="border rounded-lg shadow p-4 bg-white w-full last:mr-6 h-[98%] pb-2">
      <div>
        ...
        <p className="text-sm text-gray-500 mb-5">Survey has {survey.questions.length} questions </p>
