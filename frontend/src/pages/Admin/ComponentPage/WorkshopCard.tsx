	...
	return (
		<div className="text-black text-sm font-medium space-y-2 w-full pt-4 pb-7">
			...
			<p>
				...
				{formatDate(webinar.webinar.startTime)}
			</p>

			<p>
				<span className="font-semibold text-left">Time</span>{" "}
				{formatTime(webinar.webinar.startTime)}
			</p>

			<p>
				<span className="font-semibold text-left">Length</span>{" "}
				{formatLength(webinar.webinar.duration)}
			</p>
		</div>
	);
};
