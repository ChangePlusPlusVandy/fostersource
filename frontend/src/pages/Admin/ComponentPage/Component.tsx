...
export default function Component({ workshop, survey, certificate }: InclusiveSupportPageProps) {
  return (
  <div className="flex flex-row w-full gap-3">
    <WorkshopCard prerequisites={{
    survey: "",
    certificate: ""
  }} setPrerequisites={function (value: SetStateAction<{ survey: string; certificate: string; }>): void {
    throw new Error("Function not implemented.");
  } } />
  <SurveyCard prerequisites={{
    survey: "",
    certificate: ""
  }} setPrerequisites={function (value: SetStateAction<{ survey: string; certificate: string; }>): void {
    throw new Error("Function not implemented.");
  } } />
  <CertificateCard workshop={undefined} prerequisites={{
    survey: "",
    certificate: ""
  }} setPrerequisites={function (value: SetStateAction<{ survey: string; certificate: string; }>): void {
    throw new Error("Function not implemented.");
