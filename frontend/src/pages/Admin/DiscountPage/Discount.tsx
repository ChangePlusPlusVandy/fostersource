    ...
    <div className="w-full min-h-screen bg-gray-100">
      <div className="max-w-screen-2xl mx-auto px-8 py-6">
          ...
          {discounts.map((discount) => (
            <div
              ...
              className={`flex items-center justify-between w-full p-4 rounded-lg ${
                discount.selected ? 'bg-purple-50' : 'bg-white'
              }`}
            >
              <div className="flex items-center space-x-8 flex-1">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="bg-purple-100 text-purple-800 text-xs px-2 py-0.5 rounded-full">%</span>
                </div>
        ...
        <div className="flex justify-end gap-2 mt-6">
          ...
          <button className="p-2 bg-purple-600 text-white rounded-lg">1</button>
