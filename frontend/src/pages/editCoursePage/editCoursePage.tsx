                    ...
                    <div className="flex flex-row">
                        ...
                        <div className="mt-4 ml-20 gap-1 flex flex-col text-sm">
                            <div className="flex flex-row">
                                ...
                                <p className="text-gray-400 text-xs leading-none ml-2">(optional) </p>
                            </div>
                            <select className="w-52 p-2 border rounded-lg focus:ring-2 focus:ring-blue-500">
                                <option value="1">None Selected</option>
                                <option value="2">Option 2</option>
                            ...
                            <div className="p-4 w-[1095px] h-[250px] border rounded-md shadow-md">
                                ...
                                <div className="flex flex-row">
                                    ...
                                    <p className="text-xs ml-5 whitespace-nowrap">
                                        {date.toDateString()} at {date.toLocaleTimeString("en-US",{hour: "2-digit", minute: "2-digit",})} ({date.toLocaleTimeString("en-US", {timeZoneName:"short"}).split(" ").pop()})
                                    </p>
